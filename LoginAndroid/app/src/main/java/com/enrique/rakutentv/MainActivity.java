...
public class MainActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*INICIAMOS LAS COMPONENTES objetos del layout*/
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // o User usuario=new User(emailenter,passwordenter);
    ...
    /*INICIAMOS LOS COMPONENTES CON UN METODO*/
    ...
    public void sucessLogin(User usuario) {
        ...
        startActivity(intent);*/ // con esto nos iriamos a otra pantalla cuando sea exitoso el login
    }
